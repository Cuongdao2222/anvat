<html>
    <head>
        ...
        <link href="{{ asset('css/shared.market.min.css') }}?ver=5 " rel="stylesheet">
 ...
 -->
            ...
            <button class="scroll-to-top" style="display: inline;"><i class="fa fa-angle-double-up" aria-hidden="true" title="Lên đầu trang" onclick="toup()"></i></button>
        </div>
